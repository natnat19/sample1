<?php 
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $sql = "INSERT INTO `subjects`( `subjectName`, `subjectDescription`, `courseID`, `instructorID`) VALUES ('$subjectName', '$subjectDescription', '$courseID', '$instructorID')";
      ...
      <a href="index.php" class="btn btn-success">Back</a>
        <form action="" method="POST">
            ...
            <div class="form-group mb-2">
                ...
                <input type="number" class="form-control" name="instructorID">
            </div>
